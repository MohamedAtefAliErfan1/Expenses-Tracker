...
public class statismonthadapter extends ExpandableRecyclerAdapter<taskgroup,Task, statismonthadapter.daytasks, statismonthadapter.taskschild> {
    ...
    int pos=0;
    public statismonthadapter(Context context, @NonNull List<taskgroup> parentList) {
        super(parentList);
